...
Each case defines:
  ...
  - valid_shape: (valid_rows, valid_cols) — effective computation region.
                 ...
                 For unaligned cases: valid_cols can be any value.
...
CASES = [
    # f32 cases - basic shapes (aligned)
    {
        "name": "f32_1x32",
        "dtype": np.float32,
        "src_shape": (1, 32),
    ...
    # f32 cases - multiple rows (aligned)
    {
        "name": "f32_2x32",
        "dtype": np.float32,
        "src_shape": (2, 32),
    ...
    # f32 cases - large shape (multiple vbitsort calls, aligned)
    {
        "name": "f32_1x8192",
        "dtype": np.float32,
    ...
    # f16 cases - basic shapes (aligned)
    {
        "name": "f16_1x32",
        "dtype": np.float16,
        "src_shape": (1, 32),
