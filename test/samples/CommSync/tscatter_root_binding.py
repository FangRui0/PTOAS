    ...
    with Context() as ctx:
        ...
        with Location.unknown(ctx):
            ...
            with InsertionPoint(entry):
                ...
                src = _make_part(src_ptr, tv_f32, pv_f32, c0, c1, c256)
                dst0 = _make_part(dst0_ptr, tv_f32, pv_f32, c0, c1, c256)
                dst1 = _make_part(dst1_ptr, tv_f32, pv_f32, c0, c1, c256)
                dst2 = _make_part(dst2_ptr, tv_f32, pv_f32, c0, c1, c256)
                dst3 = _make_part(dst3_ptr, tv_f32, pv_f32, c0, c1, c256)
                group = [dst0, dst1, dst2, dst3]
