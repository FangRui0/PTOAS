    ...
    with Context() as ctx:
        ...
        with Location.unknown(ctx):
            ...
            with InsertionPoint(entry):
                input_ptr, out0_ptr, out1_ptr, out2_ptr, out3_ptr, my_rank, nranks = entry.arguments
                ...
                src = _make_part(input_ptr, tv_f32, pv_f32, c0, c1, c256)
                out0 = _make_part(out0_ptr, tv_f32, pv_f32, c0, c1, c256)
                out1 = _make_part(out1_ptr, tv_f32, pv_f32, c0, c1, c256)
                out2 = _make_part(out2_ptr, tv_f32, pv_f32, c0, c1, c256)
                out3 = _make_part(out3_ptr, tv_f32, pv_f32, c0, c1, c256)
                group = [out0, out1, out2, out3]
                ...
                with InsertionPoint(root_if.then_block):
                    pto.TBroadcastOp(src, ping, group, root=1)
                    scf.YieldOp([])
