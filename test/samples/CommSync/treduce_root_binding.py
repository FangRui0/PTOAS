    ...
    with Context() as ctx:
        ...
        with Location.unknown(ctx):
            ...
            with InsertionPoint(entry):
                input0_ptr, input1_ptr, input2_ptr, input3_ptr, output_ptr, my_rank, nranks = entry.arguments
                ...
                in0 = _make_part(input0_ptr, tv_f32, pv_f32, c0, c1, c256)
                in1 = _make_part(input1_ptr, tv_f32, pv_f32, c0, c1, c256)
                in2 = _make_part(input2_ptr, tv_f32, pv_f32, c0, c1, c256)
                in3 = _make_part(input3_ptr, tv_f32, pv_f32, c0, c1, c256)
                dst = _make_part(output_ptr, tv_f32, pv_f32, c0, c1, c256)
                group = [in0, in1, in2, in3]

                acc = pto.AllocTileOp(tb_f32).result
                recv = pto.AllocTileOp(tb_f32).result
