Qwen3 decode PTO kernels for A5, generated from `pypto-lib/models/qwen3/32b/qwen3_32b_decode.py` at `d3340a080dec891d6ba71425b934bfaadd6d2371`.
...
Notes:
- This directory vendors all 14 raw `.pto` fragments remapped from the current pypto-lib/main raw kernel names for the A5 lowering.
