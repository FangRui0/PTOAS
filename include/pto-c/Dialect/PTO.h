...
MLIR_CAPI_EXPORTED bool mlirPTOAttrIsATFillPadModeAttr(MlirAttribute attr);
MLIR_CAPI_EXPORTED MlirAttribute mlirPTOTFillPadModeAttrGet(MlirContext ctx, int32_t value);
MLIR_CAPI_EXPORTED int32_t mlirPTOTFillPadModeAttrGetValue(MlirAttribute attr);
